...
<svelte:head>
  <title>To Live is to Suffer | The Newtonian</title>
  <meta name="title" content="To Live is to Suffer | The Newtonian" />
  <meta
    name="description"
    content="Why is life so hard? Why do we need suffering?"
  />
  <meta name="image" content="/cover.webp" />
  <meta name="url" content="https://news.newton.ac.th/articles/1" />
  <meta name="author" content="Sakulya Kovitkoolkri" />
  <meta property="og:image" content="/cover.webp" />
  <meta property="og:url" content="https://news.newton.ac.th/articles/1" />
...
<div class="article">
  <div class="article__info">
    <h1 class="article__info--title">To Live is to Suffer</h1>
